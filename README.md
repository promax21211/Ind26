...
`migrations/0001_init.sql` → run it. Optionally also paste `seed.sql` if you want demo
rows to show up in `/admin`.

(Or via CLI: `npx wrangler d1 migrations apply freedom79-db --remote`.)
